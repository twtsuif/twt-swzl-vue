      ...
      <div class="feedbackBox">
        ...
        <div class="imgBox">
          <div class="imgContainer" v-for="(src,index) in imgList" :key="src">
            <img :src="src" alt="反馈图片"/>
            <div class="cancelImgBtn" @click="cancelImg(index)">×</div>
          </div>
        </div>
        <div class="infoBox">
          <div class="leftBlock">
...
.addImg_icon {
  height: 30px;
  width: 30px;
  background: url("../assets/images/imgC.png") center center / 60% no-repeat;
}
