<template>
  ...
  <div class="header">
    ...
    <div class="header-message">招领帖</div>
  </div>
  <!-- 提示信息 -->
  ...
  <div class="main">
    ...
    <div class="basic-message">
      ...
      <div class="basic-box">
        ...
        <div class="item2">
          <div :class="isZi51 ? 'zi5' : 'zi50'" @click="zi5change1">
            北洋园
          </div>
          <div :class="isZi52 ? 'zi5' : 'zi50'" @click="zi5change2">
            卫津路
          </div>
        </div>
      </div>
      ...
      <div class="image-box">
        ...
        <div class="item3">
          <div id="addFileBtn">
            <img :src="addFileBtnPic" v-if="addFileBtnPic" alt="物品图片"/>
    ...
    <div class="middle3">
      ...
      <div class="basic-box">
        ...
        <input
            class="item0"
            type="text"
            placeholder="如XX教A407走廊"
            v-model="post.findLocation"
        />
      </div>
      <div class="basic-box">
        <div class="tu10"></div>
        ...
        <input
            class="item0"
            type="text"
            placeholder="填写捡拾者处或其他地点"
            v-model="post.nowLocation"
        />
      </div>
    </div>
...
.tu4 {
  height: 20px;
  width: 20px;
  background: url("../assets/images/shangchuanzhaopian.png");
  background-size: 100% 100%;
  margin-left: 25px;
  margin-right: 12px;
  margin-top: 7px;
...
#addFileBtn {
  height: 80px;
  width: 80px;
  background: url("../assets/images/tianjiatupian.png");
  background-size: 100% 100%;
  margin-top: 20px;
  margin-left: 40px;
  position: relative;
...
.tu8 {
  height: 20px;
  width: 20px;
  background: url("../assets/images/qitamiaoshu.png");
  background-size: 100% 100%;
  margin-left: 25px;
  margin-right: 12px;
  margin-top: 7px;
...
.tu9 {
  height: 20px;
  width: 20px;
  background: url("../assets/images/shihuodidian.png");
  background-size: 100% 100%;
  margin-left: 25px;
  margin-right: 12px;
  margin-top: 7px;
...
.tu10 {
  height: 20px;
  width: 20px;
  background: url("../assets/images/fangzhididian.png");
  background-size: 100% 100%;
  margin-left: 25px;
  margin-right: 12px;
  margin-top: 7px;
...
.tu11 {
  height: 20px;
  width: 20px;
  background: url("../assets/images/lianxifangshi.png");
  background-size: 100% 100%;
  margin-left: 25px;
  margin-right: 12px;
  margin-top: 7px;
